...
namespace SanityCloud.Selenium.Selector
{
    class IdSelector : ISelector
    {
        ...
        {
            return CopenBrowser.driver.FindElement(By.Id(element));
        }
        ...
        public IWebElement WaitTimeForElementVar(string element, int Time, string var)
        {
            ...
            catch (Exception ErrorM)
            {
                ...
                return new WebDriverWait(CopenBrowser.driver, TimeSpan.FromSeconds(Time)).Until(ExpectedConditions.ElementIsVisible(By.Id("")));
            }
        }
        ...
        public void EnterText(string element, string value)
        {
            try
            {
                ...
                CopenBrowser.driver.FindElement(By.Id(element)).Clear();
                CopenBrowser.driver.FindElement(By.Id(element)).SendKeys(value);
            }
            catch (Exception ErrorM)
            {
        ...
        public void EnterTextWithTwoElements(string element, string element2, string element3, string var, string var2, string value)
        {
            try
            {
                CopenBrowser.driver.FindElement(By.Id(string.Format(element, var))).FindElement(By.Id(string.Format(element2, var2))).FindElement(By.Id(element3)).SendKeys(value);
            }
            catch (Exception ErrorM)
            {
                utils.writeLog("\n----- Not found element text -----\n", null);
        ...
        public void Click(string element)
        {
            ...
            {
                Thread.Sleep(500); //Wait fot set variable
                //CopenBrowser.driver.FindElement(By.Id(element)).Click();

                IWebElement Click = CopenBrowser.driver.FindElement(By.Id(element));
        ...
        public void ClicCheck(string element)
        {
            try
            {
                IWebElement ClickCheck = CopenBrowser.driver.FindElement(By.Id(element));
                IJavaScriptExecutor executor = (IJavaScriptExecutor)CopenBrowser.driver;
        ...
        public void ClickOneVariable(string element,  string var)
        {
            try
            {
                ...
                {
                    CopenBrowser.driver.FindElement(By.Id(string.Format(element, var))).Click();
                }
        ...
        public void ClickTwoElements(string element, string element2, string var)
        {
            try
            {
                CopenBrowser.driver.FindElement(By.Id(string.Format(element, var))).FindElement(By.Id(element2)).Click();
            }
            catch (Exception ErrorM)
            {
                utils.writeLog("\n----- Not found element to click-----\n", null);
        ...
        public void ClickTwoElements(string element, string element2, string element3, string var, string var2)
        {
            try
            {
                CopenBrowser.driver.FindElement(By.Id(string.Format(element, var))).FindElement(By.Id(string.Format(element2, var2))).FindElement(By.Id(element3)).Click();
            }
            catch (Exception ErrorM)
            {
                utils.writeLog("\n----- Not found element to click-----\n", null);
        ...
        public int CountItems(string element, string elementType)
        {
            try
            {
                Cconf.Instance.CounItem = CopenBrowser.driver.FindElements(By.Id(element)).Count;
        ...
        public int CountItemsTwoElementsOneVariable(string element, string element2, string var)
        {
            try
            {
                Cconf.Instance.CounItem = CopenBrowser.driver.FindElement(By.Id(string.Format(element, var))).FindElements(By.Id(element2)).Count;
        ...
        public string GetMessagesVariable(string element, string attribute, string var)
        {
            ...
            {
                    if (attribute == null)
                        return CopenBrowser.driver.FindElement(By.Id(string.Format(element, var))).Text;
                    else
                        return CopenBrowser.driver.FindElement(By.Id(string.Format(element, var))).GetAttribute(attribute);
            }
            catch (Exception ErrorM)
            {
        ...
        public string GetMessagesTwoElements(string element, string elementTwo, string attribute, string var)
        {
            ...
            {
                if (attribute == null)
                    return CopenBrowser.driver.FindElement(By.Id(string.Format(element, var))).FindElement(By.Id(elementTwo)).Text;
                else
                    return CopenBrowser.driver.FindElement(By.Id(string.Format(element, var))).FindElement(By.Id(elementTwo)).GetAttribute(attribute);
            }
            catch (Exception ErrorM)
            {
                utils.writeLog("\n----- Not found element to Getmessages-----\n", null);
        ...
        public string GetMessagesTwoVariables(string element, string elementTwo, string elementThree, string attribute, string var, string var2)
        {
            ...
            {
                if (attribute == null)
                    return CopenBrowser.driver.FindElement(By.Id(string.Format(element, var))).FindElement(By.Id(string.Format(elementTwo, var2))).FindElement(By.Id(elementThree)).Text;
                else
                    return CopenBrowser.driver.FindElement(By.Id(string.Format(element, var))).FindElement(By.Id(string.Format(elementTwo, var2))).FindElement(By.Id(elementThree)).GetAttribute(attribute);
            }
            catch (Exception ErrorM)
            {
                utils.writeLog("\n----- Not found element to Getmessages-----\n", null);
        ...
        public string GetMessages(string element, string attribute)
        {
            ...
            {
                if (attribute == null)
                    return CopenBrowser.driver.FindElement(By.Id(element)).Text;
                else
                    return CopenBrowser.driver.FindElement(By.Id(element)).GetAttribute(attribute);
            }
            catch (Exception ErrorM)
            {
                utils.writeLog("\n----- Not found element to Getmessages-----\n", null);
        ...
        public bool DisplayedElement(string element)
        {
            try
            {          
                return CopenBrowser.driver.FindElement(By.Id(element)).Displayed;
            }
            catch (Exception ErrorM)
            {
                utils.writeLog("\n----- Not found element to Getmessages-----\n", null);
        ...
        public bool IsEnabled(string element)
        {
            try
            {
                return CopenBrowser.driver.FindElement(By.Id(element)).Enabled;
            }
            catch (Exception ErrorM)
            {
        ...
        public void assertElementImage(string scnearioDesc, string element, string text)
        {
            try
            {
                ...
                Assert.IsTrue(CopenBrowser.driver.FindElement(By.Id(element)).Displayed);
